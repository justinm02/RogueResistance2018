...
public class CraterAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        try {
            ...
            //start up detection on phone
            detector.enable();
            pause(1);
            telemetry.addData("x position", detector.getXPosition());
            telemetry.update();

            //determine how to get to cube based on its determined position
            int extraDistance = 14;
            ...
            move(-extraDistance - 35, .7);
            pause(.25);
            //turn and move to depot
            turn(135, "left");
            pause(.25);
            strafe(8, .3, "left");
            pause(.25);
